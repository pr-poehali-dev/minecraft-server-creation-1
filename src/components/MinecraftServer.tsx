...
const donatePackages = [
  {
    ...
    price: "199₽",
    description:
      "Базовый набор для комфортного старта на сервере. Включает основные привилегии и немного ресурсов.",
    features: [
      "Приват территории 10x10",
      "Защита от гриферов",
  ...
  },
  {
    ...
    originalPrice: "699₽",
    description:
      "Расширенный набор для активных игроков. Больше привилегий, ресурсов и уникальные возможности.",
    features: [
      "Приват территории 25x25",
      "Набор железных инструментов",
      "2000 монет в игре",
      'Кит "Воин" раз в день',
      "Доступ к /tp к игрокам",
      "Цветной ник в чате",
    ],
  ...
  },
  {
    ...
    price: "999₽",
    description:
      "Премиум пакет для опытных игроков. Эксклюзивные привилегии и расширенные возможности.",
    features: [
      "Приват территории 50x50",
      "Алмазный набор инструментов",
      "5000 монет в игре",
      'Кит "Лорд" раз в день',
      "Личный варп",
      "Доступ к креативу",
  ...
  },
  {
    ...
    price: "1999₽",
    description:
      "Максимальный пакет привилегий. Полный доступ ко всем возможностям сервера и эксклюзивный контент.",
    features: [
      "Приват территории 100x100",
      "Незеритовый набор + энчанты",
      "15000 монет в игре",
      'Кит "Император" раз в день',
      "Множественные варпы",
      "Доступ к WorldEdit",
      "Особый префикс и эффекты",
